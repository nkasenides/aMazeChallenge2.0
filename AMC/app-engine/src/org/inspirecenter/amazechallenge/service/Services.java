...
public class Services {
    ...
    public static RuntimeResponse runtime(byte[] data, Object[] optionalParams) throws ServiceNotFoundException {    
        try {        
            RuntimeRequest request = RuntimeRequest.parseFrom(data);            
            return new Runtime().serve(request, optionalParams);            
        } catch (InvalidProtocolBufferException e) {        
            throw new ServiceNotFoundException("Your request data did not match the expected service request type (RuntimeRequest).", e);            
        }        
    }    
    ...
    public static LeaveChallengeResponse leaveChallenge(byte[] data, Object[] optionalParams) throws ServiceNotFoundException {    
        try {        
            LeaveChallengeRequest request = LeaveChallengeRequest.parseFrom(data);            
            return new LeaveChallenge().serve(request, optionalParams);            
        } catch (InvalidProtocolBufferException e) {        
            throw new ServiceNotFoundException("Your request data did not match the expected service request type (LeaveChallengeRequest).", e);            
        }        
    }    
