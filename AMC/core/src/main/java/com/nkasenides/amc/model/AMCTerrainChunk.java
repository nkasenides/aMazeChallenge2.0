...
public class AMCTerrainChunk implements Transmittable<AMCTerrainChunkProto.Builder>, ITerrainChunk {
    ...
    @Override    
    public com.nkasenides.amc.proto.AMCTerrainChunkProto.Builder toProto() {    
        com.nkasenides.amc.proto.AMCTerrainChunkProto.Builder protoBuilder = com.nkasenides.amc.proto.AMCTerrainChunkProto.newBuilder();        
        HashMap<String,com.nkasenides.amc.proto.AMCTerrainCellProto> cellsMap = new HashMap<>();        
        for (java.util.Map.Entry<String,com.nkasenides.amc.model.AMCTerrainCell> entry : cells.entrySet()) {        
